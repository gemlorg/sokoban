...
/* package sokoban-0.1.0.0 */
#ifndef VERSION_sokoban
#define VERSION_sokoban "0.1.0.0"
#endif /* VERSION_sokoban */
#ifndef MIN_VERSION_sokoban
#define MIN_VERSION_sokoban(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sokoban */
...
#define CURRENT_COMPONENT_ID "sokoban-0.1.0.0-inplace-sokoban"
